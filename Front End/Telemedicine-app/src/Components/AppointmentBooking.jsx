...
const styles = {
  ...
  searchBar: { display: 'flex', alignItems: 'center', backgroundColor: '#f1f3f5', padding: '10px 15px', borderRadius: '10px', marginBottom: '20px' },
  searchInput: { border: 'none', backgroundColor: 'transparent', width: '100%', marginLeft: '10px', outline: 'none', fontSize: '15px' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))', gap: '20px' },
  doctorCard: { border: '1px solid #eee', padding: '20px', borderRadius: '12px', transition: '0.3s' },
  specialty: { color: '#007bff', fontWeight: 'bold', fontSize: '14px', marginBottom: '10px' },
  infoRow: { display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: '#666', marginBottom: '5px' },
  priceRow: { marginTop: '10px', fontSize: '15px' },
  bookBtn: { width: '100%', marginTop: '15px', padding: '10px', backgroundColor: '#007bff', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer' },
  successContainer: { textAlign: 'center', padding: '50px' },
  detailsBox: { padding: '20px', border: '1px solid #eee', borderRadius: '12px' },
  slotGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginTop: '20px' },
  slotBtn: { padding: '12px', border: '1px solid #007bff', color: '#007bff', borderRadius: '8px', backgroundColor: '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' },
  backBtn: { marginTop: '20px', padding: '10px 20px', backgroundColor: '#333', color: '#fff', borderRadius: '5px', border: 'none', cursor: 'pointer' },
  textBtn: { border: 'none', background: 'none', color: '#007bff', cursor: 'pointer', marginBottom: '10px' }
};
